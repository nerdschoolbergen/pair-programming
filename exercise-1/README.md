...
:pencil2: After installing [Node.js LTS](https://nodejs.org), open up a command line window (Command Prompt or Powershell in Windows or Terminal in macOS) and type `node -v`, you should see a version number:
